                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content" style={{ backgroundColor: "transparent", border: "none" }}>
                            ...
                            <div className="modal-body">
                                ...
                                <h3 id="loadertext" style={{ textAlign: "center", color: "white" }}>Loading...</h3>
                            </div>
                            ...
                            <div className="form_container px-4 py-3">
                                ...
                                <div className="form_body">
                                    ...
                                    <div className="form-group d-flex justify-content-end gap-3">
                                        ...
                                        <ClientButton func={"MainApplication.ReportComponent.updateRoute"} clax={"btn btn-primary"} prop="" attr="">
                                            Update
                                        </ClientButton>
                                    </div>
                                </div>
                        ...
                        <div className="modal-content">
                            <div className="success-bar">
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <div className="success-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 13l4 4L19 7" /></svg></div>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                                </div>
                                <div style={{ textAlign: 'center' }}>
                                    <div className="success-title">Survey Sent Successfully!</div>
                                    <div className="success-msg" id="success-msg">Data recorded and reflected in analytics.</div>
                                    <button type="button" className="btn btn-ghost" data-bs-dismiss="modal" style={{ marginLeft: 'auto' }}>💡 Submit Another Idea</button>
                                </div>
                            </div>
                        </div>
                    </div>
